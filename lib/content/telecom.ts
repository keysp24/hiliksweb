...
const content: IndustryContent = {
  slug: 'telecom',
  heroLead:
    'Connected, automated telecom operations — OSS/BSS modernization, network operations and monitoring, intelligent automation, and managed services and analytics for operators across India and the GCC.',
  overview: [
    ...
    'We deliver across the Indian telecom ecosystem and GCC operators, combining hands-on experience with order management, charging, mediation and network monitoring with modern data platforms, intelligent automation and 24×7 managed services — engineered for the availability, scale and regulatory expectations operators demand.',
  ],
  stats: [
